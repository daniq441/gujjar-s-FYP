      ...
      <div class="row">
        <div class="col-sm-6 col-md-3">
          <div class="footer-links">
            <h5 class="lead footer-hdr">For Cv builder</h5>
            ...
            <div class="footer-link-list">
             ...
             <a href="/cv-page" class="footer-links">Create CV</a>
             <a href="/cover-letter-page" class="footer-links">Create Cover letter</a>
        ...
        <div class="col-sm-6 col-md-3">
          <div class="footer-links">
            <h3 class="footer-brand mb-2">Cv Builder</h3>
            <div class="footer-link-list">
             <a href="#" class="footer-links"><i class="fas fa-compass"></i> Raiwind Rd, near Bhubattian, chowk, Lahore, Punjab</a>
             ...
             <a href="mailto:info@joblister.com" class="footer-links"><i class="fas fa-envelope"></i> info@cvbuilder.com</a>
