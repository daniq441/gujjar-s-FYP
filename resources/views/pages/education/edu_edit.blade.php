...
@section('content')
    <section class="container bg-white border my-2">
        ...
        @if(@isset($bg_color))
        <form action="/education-update/{{ $image}}/{{$color}}/{{ $bg_color }}/{{ $templatePath }}/{{ $edu_data->id }}" method="POST" onsubmit="return educationValidation()">
        @else
        <form action="/education-update/{{ $image}}/{{$color}}/{{ $templatePath }}/{{ $edu_data->id }}" method="POST" onsubmit="return educationValidation()">
        @endif
            @csrf
            <div class="">
                <div class="">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div role="combobox" class="autosuggest-container">
                                    <input type="text" class="form-control autosuggest" placeholder="(i.e). University Of Lahore" name="SCHO" id="school" maxlength="50" spellcheck="true" value="{{ $edu_data->school_name }}" oninput="scName()">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div role="combobox" class="autosuggest-container">
                                    <input type="text" class="form-control autosuggest" placeholder="(i.e). Lahore city, Pakistan" name="SCLO" id="SCLO" maxlength="50" autosuggesttype="googleplaces" spellcheck="true" value="{{ $edu_data->school_location }}" oninput="scLocation()">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div role="combobox" class="autosuggest-container">
                                    <input type="text" class="form-control autosuggest" placeholder="(i.e). Bachelor of science in Computer Science" name="STUY" id="STUY" maxlength="50" autosuggesttype="fieldofstudy" spellcheck="true" value="{{ $edu_data->field_of_study }}" oninput="education()">
